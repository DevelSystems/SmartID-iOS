...
// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.20.104 clang-2100.3.20.102)
#ifndef SMARTID_SWIFT_H
#define SMARTID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmartId",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
